...
"""
    ...
    def run(self, query):
        print(f"Processing query (V0): {query}")
        response = self.rag_chain.invoke(query)
        return response

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run V0 Pure Naive RAG")
