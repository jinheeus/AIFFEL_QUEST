...
[목표]
문서가 질문과 조금이라도 관련이 있다면 'yes'로 평가하십시오.
- 질문이 일반적인 절차나 방법을 묻는 경우, **구체적 사례나 유사 규정**만 있어도 **매우 유용한 답변**이 될 수 있으므로 반드시 **'yes'**로 평가하십시오.
- 완전히 다른 주제(예: '횡령' 질문에 '성희롱' 문서)인 경우에만 'no'를 주십시오.
